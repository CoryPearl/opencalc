...
#define OPENCALC_SCRIPT_ALLOW_FOREVER_LOOPS 1 // Run until completion or Back/Clear; cooperative watchdog checks remain active
...
#if OPENCALC_SCRIPT_ALLOW_FOREVER_LOOPS != 0 && OPENCALC_SCRIPT_ALLOW_FOREVER_LOOPS != 1
#error "OPENCALC_SCRIPT_ALLOW_FOREVER_LOOPS must be 0 or 1"
#endif
