...
## For the commit hook and Codex integration

When the user asks to install the post-commit auto-rebuild hook or wire graphify into a project's Codex instructions, see `references/hooks.md`.
